...
//        spinner.setAdapter(adapter);
        date = findViewById(R.id.dateFromExpense);
        ...
        date.setOnClickListener(view -> new DatePickerDialog(Add_Expense_Activity.this, datePickerFrom, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH)).show());
